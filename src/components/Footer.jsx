                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24 mb-16 text-center">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="flex flex-col items-start gap-4 mt-2">
                            ...
                            <a href="https://github.com/dragolab" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-drago-secondary hover:text-white transition-all group">
                                <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-white/30 transition-all group-hover:scale-105 text-drago-secondary">
                                    <Github className="w-4 h-4 group-hover:text-[#ffffff]" />
                                </div>
                        ...
                        <div className="flex flex-col items-start gap-4 mt-2">
                            <a href="https://wa.me/393939450653" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-drago-secondary hover:text-white transition-all group">
                                <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-white/30 transition-all group-hover:scale-105 text-drago-secondary group-hover:bg-white/10">
                                    <svg className="w-4 h-4 group-hover:text-[#25D366] transition-colors fill-current" viewBox="0 0 24 24">
                                ...
                                <span className="text-sm font-medium transition-colors">+39 393 945 0653</span>
                            </a>
                            <a href="mailto:info.dragolabs@gmail.com" className="flex items-center gap-3 text-drago-secondary hover:text-white transition-all group">
                                <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-white/30 transition-all group-hover:scale-105 text-drago-secondary group-hover:bg-white/10">
                                    <Mail className="w-4 h-4 group-hover:text-yellow-400 transition-colors" />
                                </div>
                                <span className="text-sm font-medium transition-colors">info.dragolabs@gmail.com</span>
                            </a>
                        </div>
                    </div>
