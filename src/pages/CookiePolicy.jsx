            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <div className="cookie-reveal opacity-0 text-center mb-16">
                    ...
                    <p className="font-sans font-light text-base md:text-lg text-gray-400 max-w-2xl mx-auto">
                        Trasparenza sull'utilizzo dei cookie tecnici su Drago Labs.
                    </p>
                ...
                <div className="space-y-8">
                    ...
                    <div className="cookie-reveal opacity-0 glass rounded-2xl p-6 md:p-8 hover:border-drago-accent/50 transition-colors duration-350">
                        ...
                        <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                            <h4 className="font-sans font-bold text-sm text-white mb-1">Cookie di Sessione e di Sistema (Tecnici)</h4>
                            <p className="font-sans font-light text-xs md:text-sm text-gray-400 leading-relaxed">
                                Necessari per la corretta visualizzazione delle pagine, per la gestione della navigazione e per mantenere lo stato della sessione. Questi cookie non raccolgono informazioni personali e vengono gestiti nel pieno rispetto della privacy.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="cookie-reveal opacity-0 glass rounded-2xl p-6 md:p-8 hover:border-drago-accent/50 transition-colors duration-350">
                        ...
                        <p className="font-sans font-light text-xs text-gray-400 mt-4 leading-relaxed">
                            Nota: Disabilitando i cookie strettamente necessari/tecnici, alcune funzionalità del sito potrebbero non essere utilizzabili o non funzionare correttamente.
                        </p>
                    </div>
